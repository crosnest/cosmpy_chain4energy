...
from cosmpy_chain4energy.ibc.core.client.rest_client import IBCCoreClientRestClient  # type: ignore
from cosmpy_chain4energy.protos.ibc.core.client.v1.query_pb2 import (
